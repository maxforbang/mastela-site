...
const NotFoundPage: NextPageWithLayout = () => {
  return (
    ...
    <div className="mx-auto h-65vh px-6 py-32 text-center sm:py-40 lg:px-8 bg-opacity-60 bg-slate-900">
      ...
      <p className="mt-4 text-base text-white/70 sm:mt-6">Sorry, we couldn&apos;t find the page you&apos;re looking for. <br /> Either it doesn&apos;t exist or our developer (Max) made a silly mistake... how embarrasing.</p>
