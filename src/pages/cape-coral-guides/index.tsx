...
import { BlogSearchBar } from "./[category]";
    ...
    <div className="bg-white py-8">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="ml-auto mt-10 w-max">
          <Link
            href="/cape-coral-guides/all-articles"
...
export async function getStaticProps() {
  const featuredCategoriesQuery = groq`*[_type == 'category' && slug != null && slug.current != 'all-articles'] {
    title,
    slug,
    image
  }`;
