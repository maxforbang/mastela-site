    ...
    <main className="isolate">
      <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-indigo-100/20">
        <div
          ...
          aria-hidden="true"
        />
        <div className="mx-auto max-w-7xl px-6 py-32 pt-8 sm:pt-16 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
            ...
            <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
              <p className="text-lg leading-8 text-gray-600">
                We&apos;re new on the block, but that doesn&apos;t mean we&apos;re new to the
                industry. Our team has been taking care of guests for over a
                decade.
                <br />
                <br />
      ...
      <div className="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
            Inside, you&apos;ll discover a world of convenience at your fingertips.
            Control the temperature of the heated pool and spa, adjust the
            lights to create the perfect ambiance, and even set the mood with
            your favorite music and entertainment options, all from a single
            user-friendly app.
          </p>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
            <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-600">
                ...
                property. It&apos;s about feeling supported and cared for throughout
                your entire journey. That&apos;s why our dedicated support team is
