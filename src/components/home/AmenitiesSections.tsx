...
const amenities: CaptionedImage[] = [
  ...
  {
    text: "Heated Pools & Spas",
    imageUrl:
      "https://cdn.sanity.io/images/n9q65f5k/production/41aecff97aeaf842c995a25d10d3fdf1ce34787d-3000x2000.jpg?w=1000",
  },
  {
    text: "Gulf-Access Boat Docks",
    imageUrl:
      "https://cdn.sanity.io/images/n9q65f5k/production/62f2f8adef0bd62739016504464d55959ba04f00-3000x2000.jpg?w=800",
  },
  {
    text: "Pet-Friendly Spaces",
    imageUrl:
      "https://images.unsplash.com/photo-1618173745276-71981719c0ce?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=512&q=80",
  },
  {
    text: "Kayaks & Bikes",
    imageUrl:
      "https://images.unsplash.com/photo-1450500392544-c2cb0fd6e3b8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&h=400&q=80",
  },
  {
    text: "BBQ Grills",
    imageUrl:
      "https://cdn.sanity.io/images/n9q65f5k/production/18e5bc99ac80f7cf30befc08263ceee9520b54c0-1800x1200.jpg?w=800",
  },
];
    ...
    <div className="mx-auto min-h-screen bg-white py-8 sm:py-32 sm:pb-16 sm:pt-12">
      <div className="mx-auto lg:px-4">
        <div className="mx-auto sm:text-center ">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-lg leading-8 text-gray-600 sm:mt-4">
