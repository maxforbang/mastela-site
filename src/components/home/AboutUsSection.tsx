          ...
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
              ...
              <div className="mt-10 flex items-center gap-x-6">
                ...
                <Link
                  href="/about"
                  className="text-center text-sm font-semibold leading-6 text-gray-900 md:w-1/5 hover:text-gray-400"
                >
            ...
            <div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
              <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80 -z-10">
